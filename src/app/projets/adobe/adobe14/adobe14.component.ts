...
@Component({
  selector: 'app-adobe14',
  imports: [CommonModule, RouterModule],
  templateUrl: './adobe14.component.html',
  styleUrl: './adobe14.component.css',
})
export class Adobe14Component {
  filePath: string = environment.filePath;
  imagePath: string = environment.imagePath + 'adobe/adobe14/';
