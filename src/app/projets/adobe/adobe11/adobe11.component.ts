...
@Component({
  selector: 'app-adobe11',
  imports: [CommonModule, RouterModule],
  templateUrl: './adobe11.component.html',
  styleUrl: './adobe11.component.css',
})
export class Adobe11Component {
  filePath: string = environment.filePath;
  imagePath: string = environment.imagePath + 'adobe/adobe11/';
