...
@Component({
  selector: 'app-adobe12',
  imports: [CommonModule, RouterModule],
  templateUrl: './adobe12.component.html',
  styleUrl: './adobe12.component.css',
})
export class Adobe12Component {
  filePath: string = environment.filePath;
  imagePath: string = environment.imagePath + 'adobe/adobe12/';
